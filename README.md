...
Интерфейс управления ресурсами системы. Базовый префикс: **/api/v1**

**1. Лицевые счета (/accounts)**
* POST / — Регистрация нового л/с абонента.
 ```json
 Payload:
 json
{
  "number": "9852-963-7",
  "address": "г. Приозерск, ул. Ленина, д. 12, кв. 4",
  "payer": "Петров А.С."
  "residentRegd": 2
}
 ```
  ...
  * POST /batch — Массовый импорт данных (оптимизировано для миграции баз).
  * PATCH /{id} — Обновление данных профиля и статуса счета.
  * GET /bill — Формирование и выгрузка квитанции в PDF (параметры: number, period).
